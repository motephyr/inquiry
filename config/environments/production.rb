Rails.application.configure do
  ...
  # config.action_controller.asset_host = 'plato.ns.cloudflare.com'
  # ['dora.ns.cloudflare.com','plato.ns.cloudflare.com']
  ...
  config.action_cable.url = "wss://#{Setting.domain_name}/cable"
